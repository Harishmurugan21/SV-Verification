...
module sync_fifo #(parameter fifo_width=8,fifo_depth=16)(
  ...
  //internal memory and pointer counter
  ...
  //assign full=((w_pntr[pntr_width-1]==r_pntr[pntr_width-1])&&(w_pntr[pntr_width]!=r_pntr[pntr_width]));
